    ...
    public partial class Employee : Form
    {
        ...
        private void button1_ins_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if(string.IsNullOrEmpty(textBox1_SID.Text))
                {
                    MessageBox.Show("Please Enter a proper supervisorID");
                }
                if(!string.IsNullOrEmpty(textBox1_SID.Text))
                { 
        ...
        private void textBox1_SID_TextChanged(object sender, EventArgs e)
        {
